...
tf.app.flags.DEFINE_boolean(
    'is_gt', False,
    'Load ground truth file generated by using cam and gps')

FLAGS = tf.app.flags.FLAGS

_FILE_TIMES = 'timestamps.txt'
_FILE_CONFIGS = 'configs.txt'
...
def get_configs(f_configs):
    ...
    cfg_list = ['f_video','f_lidar','fps_video','fps_lidar',
                'time_lidar','time_tower','t_sync_tower']
    cfg_type = [str,str,int,int,float,float,float]
...
def gen_data(split,list_dpath,out_path,fps_out,
    ...
    opath_label_lidar = os.path.join(out_path,'label_lidar_new')
                ...
                if i_frame % r_fps_cam == 0:
                    ...
                    if is_gt:
                        in_gt = os.path.join(gt_path,
                                             _FILE_OUT.format(i_save-sum_frames_gt)+'.txt')
